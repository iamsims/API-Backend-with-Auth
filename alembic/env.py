...
DB_USERNAME = decouple_config('DB_USERNAME') or None
if DB_USERNAME is None:
    raise 'Missing DB_USERNAME'

DB_PASSWORD = decouple_config('DB_PASSWORD') or None
if DB_PASSWORD is None:
    raise 'Missing DB_PASSWORD'

DB_HOST = decouple_config('DB_HOST') or None
if DB_HOST is None:
    raise 'Missing DB_HOST'

DB_NAME = decouple_config('DB_NAME') or None
if DB_NAME is None:
